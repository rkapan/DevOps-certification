pipeline {
    ...
    stages {
        ...
        stage('Git Checkout') {
            agent{ label 'slave'}
            steps {
                sh "if [ ! -d '/home/jenkins/jenkins_slave/workspace/Certification' ]; then git clone https://github.com/rkapan/DevOps-certification.git /home/jenkins/jenkins_slave/workspace/Certification ; fi"
